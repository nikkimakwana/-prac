    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="row">
                    <div class="col-12">
                        {!! Form::open(['route' => ['product.update',$productData->id],'id' => 'form_submit','method' => 'PUT','class' => 'parsley-examples','files' => true,'enctype' => 'multipart/form-data','data-parsley-validate']); !!}
                        @csrf
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                {!! Form::text('name',$productData->product_name,[
                                'id' => 'name',
                                'placeholder' => 'Name',
                                'class' => 'form-control',
                                'required' => 'required',
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                {!! Form::text('quantity',$productData->quantity,[
                                'id' => 'quantity',
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                {!! Form::select('status[]', array('active' => 'Active', 'deactive' => 'Deactive'), $productData->status, [
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                {!! Form::hidden('old_profileimage',$productData->profileimage) !!}
                                {!! Form::file('profileimage',[
                                'id' => 'profileimage',
                                'class' => 'dropify',
                                'data-default-file' => $productData->profileimage == ''?asset('assets/admin/images/defaultimage.png'):$productData->profileimage,
